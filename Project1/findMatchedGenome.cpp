...
// Main here can just be used to make all the genomes and the sequence necessary to get the code to run the find Matched genome
// function with specified inputs.
int main()
{
